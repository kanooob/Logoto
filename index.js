...
const S4D_WEBSITECREATION_EXPRESS_app = S4D_WEBSITECREATION_EXPRESS();
    ...
    S4D_WEBSITECREATION_EXPRESS_app.use(S4D_WEBSITECREATION_bodyParser.json());
      ...
      S4D_WEBSITECREATION_EXPRESS_app.get('/help', async function(req, res) {
        ...
        </html>`), String('index.html'), { overwrite: true });res.sendFile(S4D_WEBSITECREATION_path.join(__dirname, String('index.html')))
