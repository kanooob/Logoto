    ...
    */
    ...
    s4d.client.on('ready', async () => {
      ...
      s4d.client.channels.cache.get('1413899996691955755').send({content:String('Démarrage du bot...')});
        ...
        S4D_APP_PKG_axios({
                method: "post",
                url: ('https://logoto.onrender.com/api/serveur-counte?server=' + String(s4d.client.guilds.cache.size)),
    ...
    s4d.client.on('interactionCreate', async (interaction) => {
      ...
      if ((interaction.commandName) == 'info') {
        await interaction.reply({ content: (['<:track_next:1505295937856213072> **Useful links**','\n','<:link:1505215573364047913> [Website](https://logoto.onrender.com/), [Support Server](https://discord.gg/TPXFVYVnXe), [ToS](https://logoto.onrender.com/tos), [Privacy Policy](https://logoto.onrender.com/privacy).','\n','<:link:1505215573364047913> [Site](https://logoto.onrender.com/fr), [Serveur de support](https://discord.gg/TPXFVYVnXe), [ToS](https://logoto.onrender.com/tos), [Politique de Confidentialité](https://logoto.onrender.com/privacy).'].join('')), ephemeral: false, components: [] });
      }
